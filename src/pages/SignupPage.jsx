    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 pt-20">
      ...
      <div className="relative max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-secondary">Start your learning journey today - it&apos;s free!</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  spellCheck="false"
                  autoComplete="name"
                  className="w-full pl-12 pr-4 py-3 bg-base/50 border border-line/20 rounded-xl text-primary placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-all"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 bg-base/50 border border-line/20 rounded-xl text-primary placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-all"
                />
                <button
                  type="button"
